...
using ProtoBuf;
#if PSM
using PsmQuaternion = Sce.PlayStation.Core.Quaternion;
#endif
...
#if PSM
		public static implicit operator PsmQuaternion(Quaternion a)
		{
			return new PsmQuaternion(a.Xyz, a.W);	
		}
		
		public static implicit operator Quaternion(PsmQuaternion a)
		{
			return new Quaternion(a.X, a.Y, a.Z, a.W);	
		}
#elif PC
        public static implicit operator Microsoft.Xna.Framework.Quaternion(Quaternion a)
        {
            return new Microsoft.Xna.Framework.Quaternion(a.Xyz, a.W);
        }

        public static implicit operator Quaternion(Microsoft.Xna.Framework.Quaternion a)
        {
            return new Quaternion(a.X, a.Y, a.Z, a.W);
        }
#endif 
