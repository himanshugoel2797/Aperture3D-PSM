...
{
	public class Billboard:IShaderNode
	{
		private static ShaderProgram simpleShader;
		private Vector4 Color; 
		
		public Billboard () : this(Vector4.UnitW)
		{
			
		}
		
		public Billboard(Vector4 col)
		{
		...
		{
			Matrix4 WVP = RootNode.GetCurrentScene().ProjectionMatrix * renderer.WorldMatrix;
